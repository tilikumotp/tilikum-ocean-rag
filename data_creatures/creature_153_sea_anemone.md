...
tags: [Anthozoa orders, Articles containing Thai-language text, Articles containing video clips, Articles using diversity taxobox, Articles with 'species' microformats]
source: "Wikipedia Scientific Archive"
language: "en"
---

# 🐋 Marine Creature Dossier: Sea anemone

**Target Category:** Marine Biology  
**Scientific / Ecological Tags:** Anthozoa orders, Articles containing Thai-language text, Articles containing video clips, Articles using diversity taxobox, Articles with 'species' microformats  

---

## 📖 Overview & Biological Description

Sea anemones (  ə-NEM-ə-nee) are a group of predatory marine invertebrate animals constituting the order Actiniaria. Because of their colourful appearance, they are named after the Anemone, a terrestrial flowering plant. Sea anemones are classified in the phylum Cnidaria, class Anthozoa, subclass Hexacorallia.
...
In Thailand, in some areas such as Ko Samui and Ko Phangan, there is a local curry soup dish known as kaeng khua hed lub  (Thai: แกงคั่วเห็ดหลุบ). "Hed lub" refers to the sea anemone Stichodactyla haddoni. However, this species is classified as a protected animal in Thailand.
