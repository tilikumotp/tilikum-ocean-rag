...
tags: [Articles containing Latin-language text, Articles containing Spanish-language text, Articles containing video clips, Articles using diversity taxobox, Articles with 'species' microformats]
source: "Wikipedia Scientific Archive"
language: "en"
---

# 🐋 Marine Creature Dossier: Barnacle

**Target Category:** Marine Biology  
**Scientific / Ecological Tags:** Articles containing Latin-language text, Articles containing Spanish-language text, Articles containing video clips, Articles using diversity taxobox, Articles with 'species' microformats  
...
=== Fossil record ===
The oldest definitive fossil barnacle is Praelepas from the mid-Carboniferous, around 330–320 million years ago. Older claimed barnacles such as Priscansermarinus from the Middle Cambrian, some 510 to 500 million years ago, do not show clear barnacle morphological traits, though Rhamphoverritor from the Silurian Coalbrookdale Formation of England may represent a stem-group barnacle. Barnacles first radiated and became diverse during the Late Cretaceous. Barnacles underwent a second, much larger radiation beginning during the Neogene and still continuing.
...
Barnacles in Spain Archived 2020-02-24 at the Wayback Machine Article on barnacles in Spain, and their collection and gastronomy.
